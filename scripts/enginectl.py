...
FILES=('scripts/enginectl.py','scripts/runtime_contract.py','scripts/engine_telemetry.py','scripts/review_store.py','scripts/release_gate.py','scripts/build_release_decision.py','scripts/session_checkpoint.py','scripts/check_release_enforcement.py','scripts/profile_repository.py','scripts/resolve_stack_profile.py','scripts/check_knowledge_freshness.py','scripts/design_quality_checks.py','scripts/creative_experience_checks.py','scripts/routing_report.py','.github/workflows/ai-expert-release-gate.yml','.cursor/hooks/ai-expert-release-guard.py')
