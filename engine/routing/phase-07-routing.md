...
- R4: major production release/architecture change requires `audit-review` when systemic assessment is needed and always reaches `release-readiness` before production GO.
